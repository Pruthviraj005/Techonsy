  ...
  return (
    <section className="bg-gray-900 py-16 flex justify-center">
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
        ...
        {/* Left Section - Integration Icons (Increased Size) */}
        <div className="w-full md:w-1/4 flex flex-col items-center">
          <div className="grid grid-cols-3 gap-6">
            {[FaSlack, FaGoogleDrive, FaCloud, FaSalesforce, FaAws, FaHubspot, FaEnvelope].map((Icon, index) => (
              <div key={index} className="w-16 h-16 flex items-center justify-center bg-gray-800 rounded-lg p-3">
                <Icon className="text-white text-4xl" />
              </div>
            ))}
            <div className="w-16 h-16 flex items-center justify-center bg-gray-800 rounded-lg p-3">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          <div className="relative flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0">
            ...
            <div className="flex md:hidden flex-col items-center">
              <TbArrowBigUp className="text-blue-500 text-4xl mt-2" />
              ...
              <div className="bg-black p-6 rounded-xl flex items-center justify-center shadow-lg">
                <div className="w-20 h-20 border border-gray-600 rounded-lg flex items-center justify-center">
                  <LuAtom className="text-4xl" />
                </div>
              </div>
              <p className="text-gray-400 text-sm mt-2">AI APPLICATION</p>
              <TbArrowBigDown className="text-blue-500 text-4xl mt-2" />
            </div>

            {/* Desktop View - Horizontal Arrows */}
            <div className="hidden md:flex absolute left-[-220px] flex-col items-center">
              <FaArrowLeftLong className="text-lime-400 text-3xl w-36" />
              <p className="text-gray-400 text-sm mt-1">YOUR USER DATA</p>
              <FaArrowRightLong className="text-lime-400 text-3xl w-36" />
            </div>

            {/* Processing Block */}
            <div className="hidden md:flex bg-gradient-to-br from-[#1a1a1a] via-[#2e2e2e] to-[#0f0f0f] p-6 rounded-xl items-center justify-center shadow-lg">
              <div className="w-20 h-20 border border-gray-600 rounded-lg flex items-center justify-center">
                <LuAtom className="text-4xl" />
              </div>
            </div>
            ...
            <div className="hidden md:flex absolute right-[-220px] flex-col items-center">
              <FaArrowLeftLong className="text-blue-500 text-3xl w-36" />
              <p className="text-gray-400 text-sm mt-1">AI APPLICATION</p>
              <FaArrowRightLong className="text-blue-500 text-3xl w-36" />
            </div>
          </div>
        </div>
