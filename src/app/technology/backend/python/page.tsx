...
export default function Python () {
    ...
    return (
        <div className=" ">
            ...
            <div className="bg-gradient-to-r from-blue-700 to-[#b69c1c] px-6 lg:px-24 flex flex-col lg:flex-col items-center justify-center z-1 relative border-b-[0.5px] border-yellow">
