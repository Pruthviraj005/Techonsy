...
export default function NodeJsRoadmap() {
  // Memoized roadmap steps for performance optimization
  ...
  return (
    <section className="relative w-full max-w-6xl mx-auto py-16 px-6 bg-[#121826] overflow-hidden text-white text-center">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
        <svg
          className="absolute top-0 left-0 w-full h-full opacity-10 animate-wave"
        ...
        >
          <path
            fill="#00bcd4"
            fillOpacity="0.5"
            d="M0,160L40,186.7C80,213,160,267,240,256C320,245,400,171,480,133.3C560,96,640,96,720,138.7C800,181,880,267,960,277.3C1040,288,1120,224,1200,186.7C1280,149,1360,139,1400,133.3L1440,128L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"
          />
        </svg>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 w-full max-w-6xl mx-auto px-4">
        {roadmapSteps.map((step, index) => (
          <motion.div
            ...
            whileHover={{ scale: 1.05, boxShadow: "0px 4px 15px rgba(0, 188, 212, 0.5)" }}
          ...
          >
            <div
              className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#00bcd4] rounded-full text-white animate-pulse"
              aria-hidden="true"
            >
              {step.icon}
            </div>
            <div className="mt-4 sm:mt-0 sm:ml-4 text-left">
              <h3
                className="text-md sm:text-lg font-semibold text-[#00bcd4]"
