      ...
      {/* Animated Background */}
        ...
        <div className='max-w-[1000px] mx-auto '>
          <div className="relative z-10 container mx-auto px-4 py-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="h-full p-8 rounded-xl relative bg-opacity-10 bg-slate-700 shadow-md 
                                 backdrop-blur-lg border-[0.5px] border-gray-600 transition-all duration-300 
            ...
            {/* Frameworks Section */}
            <div className="bg-gradient-to-r from-blue-900/10 to-black rounded-2xl p-10 border border-blue-500/20 mb-20">
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="bg-gradient-to-r from-blue-900/10 to-black rounded-2xl p-10 border border-blue-500/20 mb-20"
            >
            ...
            {/* Services Section */}
            <motion.div 
              className="bg-gradient-to-r from-blue-900/10 to-black p-10 border-blue-500/20"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
