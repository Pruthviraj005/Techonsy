...
export default function Services() {
    return (
        <section className="   bg-gradient-to-r from-blue-900 via-blue-900 to-black text-white overflow-hidden relative">
            <div className='max-w-6xl w-full mx-auto px-6 sm:px-10 gap-10 py-16 flex flex-col md:flex-row items-center justify-between'>
                {/* Left Content */}
                <motion.div 
