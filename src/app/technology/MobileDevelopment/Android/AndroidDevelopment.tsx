...
export default function AndroidDevelopment() {
  return (
    <section className="relative flex flex-col lg:flex-row items-center justify-between px-6 sm:px-12 lg:px-20 py-12 lg:py-20 
      text-center lg:text-left bg-gradient-to-br from-[#0a0f1a] via-slate-950 to-black text-white">

      {/* Text Content */}
      <div className="lg:w-1/2 max-w-3xl">
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight bg-gradient-to-r from-blue-400 to-green-400 
          bg-clip-text text-transparent drop-shadow-xl"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          Transforming Ideas into <br className="hidden sm:block" /> Powerful Android Apps
        </motion.h2>
